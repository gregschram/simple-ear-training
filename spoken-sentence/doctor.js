  ...
  sentences: [
    {
        ...
        options: [
          ...
          "The lab results should arrive by Monday",
          "My insurance coverage starts next month",
          "The clinic opens at eight tomorrow"
        ]
    },
    {
        id: 2,
        ...
        options: [
          ...
          "My knee swells after exercise",
          "The rash appears in bright light",
          "My wrist aches during typing"
        ]
    },
    {
        id: 3,
        ...
        options: [
          ...
          "The technician drew some blood",
          "The specialist checked my hearing",
    ...
    },
    {
        ...
        options: [
          ...
          "The surgeon scheduled my procedure",
          "The clinic sent my referral",
          "The pharmacy filled my order"
        ]
    },
    {
        id: 5,
        ...
        options: [
          ...
          "My muscles ache since Thursday",
          "The dizziness started last week",
          "The cough began this morning"
        ]
    },
    {
        id: 6,
        ...
        options: [
          ...
          "The symptoms are improving daily",
    ...
    },
    {
        ...
        options: [
          ...
          "The pharmacy line moves slowly",
          "The elevator needs maintenance",
          "The parking lot is quite busy"
        ]
    },
    {
        id: 8,
        ...
        options: [
          ...
          "He reviewed my medications",
          "They checked my vital signs",
    ...
    },
    {
        ...
        options: [
          ...
          "The scan requires special preparation",
          "Your therapy starts next session",
          "The results need further review"
        ]
    },
    {
        id: 10,
        ...
        options: [
          ...
          "I need my flu shot today",
          "My teeth cleaning is scheduled",
    ...
    },
    {
        ...
        options: [
          ...
          "Please roll up your sleeve now",
    ...
    },
    {
        ...
        options: [
          ...
          "Is the dizziness still present?",
    ...
    },
    {
        ...
        options: [
          ...
          "The nurse suggested light exercise",
          "The diet requires less sugar",
          "The therapy needs daily practice"
        ]
    },
    {
        id: 14,
        ...
        options: [
          ...
          "The cast comes off next month",
          "Your tests are due this Friday",
          "The bandage needs changing soon"
        ]
    },
    {
        id: 15,
        ...
        options: [
          ...
          "My joints feel stiff today",
          "The cream causes rashes"
        ]
    },
    {
        id: 16,
        ...
        options: [
          ...
          "The treatment shows progress",
          "The healing looks normal"
        ]
    },
    {
        id: 17,
        ...
        options: [
          ...
          "The doctor tested my reflexes",
          "The scan showed clear results",
          "The test confirmed improvement"
        ]
    },
    {
        id: 18,
        ...
        options: [
          ...
          "The exercises will build strength",
          "The diet should reduce symptoms",
          "The rest will speed recovery"
        ]
    },
    {
        id: 19,
        ...
        options: [
          ...
          "My vision seems clearer today",
          "The pain has mostly stopped",
          "The swelling went down fast"
        ]
    },
    {
        id: 20,
        ...
        options: [
          ...
          "My ankle seems slightly weak",
          "The headache comes and goes",
          "The bruising looks lighter now"
        ]
      }
    ]
  }
